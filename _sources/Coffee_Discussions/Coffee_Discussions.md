...
*  Describe all the information/data you need (which may be available or collectable). 
*  How will you make sense of that information?
*  How will you give a mathematical form to this (Hint: define Sample Space, Event, Probability)?
...
3. Decide the number of beds in an Emergency Room
4. Decide the HVAC (based on power requirement) in COE 
5. Decide the 

1. Tossing a coin
2. \# of Car Arrivals in COE Parking Lot
3. Inspecting a Component (defective or not defective)
4. Heights of People
5. \# of Callers to a Service Center
6. Wait Times in an Emergency Room    
7. Width of Softdrink Cans
